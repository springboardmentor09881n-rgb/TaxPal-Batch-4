...
| **Reports** | `POST` | `/api/reports/preview` | Compute live report summary & preview metrics | Private |
| **Reports** | `POST` | `/api/reports/generate` | Generate and record report in history | Private |
| **Reports** | `GET` | `/api/reports` | Get all generated report history records | Private |
| **Reports** | `GET` | `/api/reports/:id` | Get details of a single report | Private |
| **Reports** | `DELETE` | `/api/reports/:id` | Delete saved report record | Private |
| **Reports** | `POST`/`GET` | `/api/reports/export/pdf` | Export financial report as styled PDF | Private |
| **Reports** | `POST`/`GET` | `/api/reports/export/csv` | Export financial report as structured CSV | Private |
| **Reports** | `GET` | `/api/reports/:id/download` | Download saved report in PDF or CSV format | Private |
